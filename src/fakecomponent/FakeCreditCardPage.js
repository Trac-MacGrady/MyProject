...
export default class FakeCreditCardPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            creditCard: false,
    ...
    onModifyCredit = (bankCardNum, bankCardMoney, bankCardRepay,bankCardBill) => {
        Actions.replace('fakemodify', {cardNum:bankCardNum, cardMoney:bankCardMoney
            , cardRepayDay:bankCardRepay, cardBillDay:bankCardBill});
    };

    bindCreditCard = () => {
       Actions.replace('fakebindcard');
    };
    ...
    render() {
        ...
        const  bankCardInfo = JSON.stringify(this.state.bankCardInfoList) ;
        ...
        return (
            <View style={styles.container}>
                ...
                {bankCardInfo !== "[]" ?
                    ...
                    :
                    <Image source={require('../../image/ic_mirror_dten_empty.png')} style={{width: width-50, height:300, marginBottom:50, marginTop:20}}/>
                }
                <Button
